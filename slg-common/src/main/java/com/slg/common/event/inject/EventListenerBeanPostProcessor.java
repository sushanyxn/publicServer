    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Method method : methods) {
            ...
            if (parameterTypes.length != 1) {
                LoggerUtil.error("事件监听器方法参数数量错误，应该有且仅有一个参数: bean={}, method={}",
            ...
            if (!IEvent.class.isAssignableFrom(eventType)) {
                LoggerUtil.error("事件监听器方法参数类型错误，必须是 IEvent 的子类: bean={}, method={}, paramType={}",
            ...
            try {
                ...
                EventBusManager.getInstance().registerListener(eventClass, wrapper);

            } catch (Exception e) {
                LoggerUtil.error("注册事件监听器失败: bean=" + beanClass.getSimpleName() + ", method=" + method.getName(), e);
            }
        }
