...
public class GcCSATrophyRetract implements org.apache.thrift.TBase<GcCSATrophyRetract, GcCSATrophyRetract._Fields>, java.io.Serializable, Cloneable, Comparable<GcCSATrophyRetract> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GcCSATrophyRetract");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GcCSATrophyRetractStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GcCSATrophyRetractTupleSchemeFactory();
  ...
  /**
   * ErrorCode 1: 成功 2: 奖杯不存在 3:这个奖杯不是本服的 4:不是国王 5:配置错误 6：奖杯已经被收起
   */
  ...
  private static final _Fields optionals[] = {_Fields.META_ID,_Fields.X,_Fields.Y,_Fields.SERVER_POS,_Fields.SERVER_ID,_Fields.ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GcCSATrophyRetract.class, metaDataMap);
  }

  public GcCSATrophyRetract() {
  }
   ...
   */
  public GcCSATrophyRetract(GcCSATrophyRetract other) {
  ...
  public GcCSATrophyRetract deepCopy() {
    return new GcCSATrophyRetract(this);
  }
   ...
   * CrossServerAttackTrophy Id *
   */
  public GcCSATrophyRetract setMetaId(@org.apache.thrift.annotation.Nullable String metaId) {
    this.metaId = metaId;
    return this;
  }
   ...
   * 服务器id
   */
  public GcCSATrophyRetract setX(int x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
   ...
   * 服务器id
   */
  public GcCSATrophyRetract setY(int y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
   ...
   * 所在服务器区域
   */
  public GcCSATrophyRetract setServerPos(byte serverPos) {
   ...
   * 服务器id
   */
  public GcCSATrophyRetract setServerId(int serverId) {
   ...
   * ErrorCode 1: 成功 2: 奖杯不存在 3:这个奖杯不是本服的 4:不是国王 5:配置错误 6：奖杯已经被收起
   */
  public GcCSATrophyRetract setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
   ...
   * 服务器生成的唯一id，非0
   */
  public GcCSATrophyRetract setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof GcCSATrophyRetract)
      return this.equals((GcCSATrophyRetract)that);
    return false;
  }

  public boolean equals(GcCSATrophyRetract that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GcCSATrophyRetract other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GcCSATrophyRetract(");
    boolean first = true;
  ...
  private static class GcCSATrophyRetractStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GcCSATrophyRetractStandardScheme getScheme() {
      return new GcCSATrophyRetractStandardScheme();
    }
  }

  private static class GcCSATrophyRetractStandardScheme extends org.apache.thrift.scheme.StandardScheme<GcCSATrophyRetract> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GcCSATrophyRetract struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GcCSATrophyRetract struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GcCSATrophyRetractTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GcCSATrophyRetractTupleScheme getScheme() {
      return new GcCSATrophyRetractTupleScheme();
    }
  }

  private static class GcCSATrophyRetractTupleScheme extends org.apache.thrift.scheme.TupleScheme<GcCSATrophyRetract> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GcCSATrophyRetract struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GcCSATrophyRetract struct) throws org.apache.thrift.TException {
