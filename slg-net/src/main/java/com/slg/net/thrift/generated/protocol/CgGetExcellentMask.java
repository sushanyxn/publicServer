...
public class CgGetExcellentMask implements org.apache.thrift.TBase<CgGetExcellentMask, CgGetExcellentMask._Fields>, java.io.Serializable, Cloneable, Comparable<CgGetExcellentMask> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CgGetExcellentMask");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CgGetExcellentMaskStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CgGetExcellentMaskTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.ROLE_ID,_Fields.ALLIANCE_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CgGetExcellentMask.class, metaDataMap);
  }

  public CgGetExcellentMask() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public CgGetExcellentMask(CgGetExcellentMask other) {
    __isset_bitfield = other.__isset_bitfield;
    this.roleId = other.roleId;
    this.allianceId = other.allianceId;
  }

  public CgGetExcellentMask deepCopy() {
    return new CgGetExcellentMask(this);
  }
   ...
   * 玩家id
   */
  public CgGetExcellentMask setRoleId(long roleId) {
    this.roleId = roleId;
    setRoleIdIsSet(true);
    return this;
  }
  ...
  public CgGetExcellentMask setAllianceId(long allianceId) {
  ...
  public boolean equals(Object that) {
    if (that instanceof CgGetExcellentMask)
      return this.equals((CgGetExcellentMask)that);
    return false;
  }

  public boolean equals(CgGetExcellentMask that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CgGetExcellentMask other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CgGetExcellentMask(");
    boolean first = true;
  ...
  private static class CgGetExcellentMaskStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CgGetExcellentMaskStandardScheme getScheme() {
      return new CgGetExcellentMaskStandardScheme();
    }
  }

  private static class CgGetExcellentMaskStandardScheme extends org.apache.thrift.scheme.StandardScheme<CgGetExcellentMask> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CgGetExcellentMask struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CgGetExcellentMask struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CgGetExcellentMaskTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CgGetExcellentMaskTupleScheme getScheme() {
      return new CgGetExcellentMaskTupleScheme();
    }
  }

  private static class CgGetExcellentMaskTupleScheme extends org.apache.thrift.scheme.TupleScheme<CgGetExcellentMask> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CgGetExcellentMask struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CgGetExcellentMask struct) throws org.apache.thrift.TException {
