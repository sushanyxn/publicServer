...
public class GcEngageCreateRoom implements org.apache.thrift.TBase<GcEngageCreateRoom, GcEngageCreateRoom._Fields>, java.io.Serializable, Cloneable, Comparable<GcEngageCreateRoom> {
   ...
   * 场次
   */
  public GcEngageCreateRoom setIndexs(@org.apache.thrift.annotation.Nullable java.util.List<Integer> indexs) {
    this.indexs = indexs;
    return this;
  }
   ...
   * 每一场的结果
   */
  public GcEngageCreateRoom setResults(@org.apache.thrift.annotation.Nullable java.util.List<com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode> results) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GcEngageCreateRoom(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexs = new java.util.ArrayList<Integer>(_list216.size);
                int _elem217;
                for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                {
                  _elem217 = iprot.readI32();
                  struct.indexs.add(_elem217);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode>(_list219.size);
                @org.apache.thrift.annotation.Nullable com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode _elem220;
                for (int _i221 = 0; _i221 < _list219.size; ++_i221)
                {
                  _elem220 = com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode.findByValue(iprot.readI32());
                  if (_elem220 != null)
                  {
                    struct.results.add(_elem220);
                  }
                }
                iprot.readListEnd();
              }
      ...
      if (struct.indexs != null) {
        if (struct.isSetIndexs()) {
          oprot.writeFieldBegin(INDEXS_FIELD_DESC);
          {
            ...
            for (int _iter222 : struct.indexs)
            {
      ...
      if (struct.results != null) {
        if (struct.isSetResults()) {
          oprot.writeFieldBegin(RESULTS_FIELD_DESC);
          {
            ...
            for (com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode _iter223 : struct.results)
            {
  ...
  private static class GcEngageCreateRoomTupleScheme extends org.apache.thrift.scheme.TupleScheme<GcEngageCreateRoom> {
      ...
      if (struct.isSetIndexs()) {
        {
          ...
          for (int _iter224 : struct.indexs)
          {
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode _iter225 : struct.results)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GcEngageCreateRoom struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list226 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.indexs = new java.util.ArrayList<Integer>(_list226.size);
          int _elem227;
          for (int _i228 = 0; _i228 < _list226.size; ++_i228)
          {
            _elem227 = iprot.readI32();
            struct.indexs.add(_elem227);
          }
        }
        struct.setIndexsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list229 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.results = new java.util.ArrayList<com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode>(_list229.size);
          @org.apache.thrift.annotation.Nullable com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode _elem230;
          for (int _i231 = 0; _i231 < _list229.size; ++_i231)
          {
            _elem230 = com.slg.net.thrift.generated.protocol.constant.PsRZEErrorCode.findByValue(iprot.readI32());
            if (_elem230 != null)
            {
              struct.results.add(_elem230);
            }
          }
        }
        struct.setResultsIsSet(true);
