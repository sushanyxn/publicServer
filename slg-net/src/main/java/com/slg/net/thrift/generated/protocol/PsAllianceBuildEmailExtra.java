...
public class PsAllianceBuildEmailExtra implements org.apache.thrift.TBase<PsAllianceBuildEmailExtra, PsAllianceBuildEmailExtra._Fields>, java.io.Serializable, Cloneable, Comparable<PsAllianceBuildEmailExtra> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PsAllianceBuildEmailExtra");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PsAllianceBuildEmailExtraStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PsAllianceBuildEmailExtraTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.X,_Fields.Y,_Fields.META_ID,_Fields.POINTS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PsAllianceBuildEmailExtra.class, metaDataMap);
  }

  public PsAllianceBuildEmailExtra() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public PsAllianceBuildEmailExtra(PsAllianceBuildEmailExtra other) {
  ...
  public PsAllianceBuildEmailExtra deepCopy() {
    return new PsAllianceBuildEmailExtra(this);
  }
   ...
   * 目的地x坐标
   */
  public PsAllianceBuildEmailExtra setX(int x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
   ...
   * 目的地y坐标
   */
  public PsAllianceBuildEmailExtra setY(int y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
   ...
   * 联盟建筑MetaId
   */
  public PsAllianceBuildEmailExtra setMetaId(@org.apache.thrift.annotation.Nullable String metaId) {
    this.metaId = metaId;
    return this;
  }
   ...
   * 获得的积分
   */
  public PsAllianceBuildEmailExtra setPoints(int points) {
    this.points = points;
    setPointsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof PsAllianceBuildEmailExtra)
      return this.equals((PsAllianceBuildEmailExtra)that);
    return false;
  }

  public boolean equals(PsAllianceBuildEmailExtra that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(PsAllianceBuildEmailExtra other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PsAllianceBuildEmailExtra(");
    boolean first = true;
  ...
  private static class PsAllianceBuildEmailExtraStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsAllianceBuildEmailExtraStandardScheme getScheme() {
      return new PsAllianceBuildEmailExtraStandardScheme();
    }
  }

  private static class PsAllianceBuildEmailExtraStandardScheme extends org.apache.thrift.scheme.StandardScheme<PsAllianceBuildEmailExtra> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PsAllianceBuildEmailExtra struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PsAllianceBuildEmailExtra struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PsAllianceBuildEmailExtraTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsAllianceBuildEmailExtraTupleScheme getScheme() {
      return new PsAllianceBuildEmailExtraTupleScheme();
    }
  }

  private static class PsAllianceBuildEmailExtraTupleScheme extends org.apache.thrift.scheme.TupleScheme<PsAllianceBuildEmailExtra> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PsAllianceBuildEmailExtra struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PsAllianceBuildEmailExtra struct) throws org.apache.thrift.TException {
