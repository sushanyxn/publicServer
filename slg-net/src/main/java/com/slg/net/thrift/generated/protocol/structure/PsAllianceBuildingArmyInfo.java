...
public class PsAllianceBuildingArmyInfo implements org.apache.thrift.TBase<PsAllianceBuildingArmyInfo, PsAllianceBuildingArmyInfo._Fields>, java.io.Serializable, Cloneable, Comparable<PsAllianceBuildingArmyInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PsAllianceBuildingArmyInfo");
  ...
  private static final org.apache.thrift.protocol.TField BUILDING_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("buildingTime", org.apache.thrift.protocol.TType.I64, (short)5);
  private static final org.apache.thrift.protocol.TField DETAIL_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("detailInfo", org.apache.thrift.protocol.TType.STRUCT, (short)6);
  ...
  private static final org.apache.thrift.protocol.TField TOTAL_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("totalTime", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField ARRIVED_FIELD_DESC = new org.apache.thrift.protocol.TField("arrived", org.apache.thrift.protocol.TType.BOOL, (short)9);
  private static final org.apache.thrift.protocol.TField ARRIVE_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("arriveTime", org.apache.thrift.protocol.TType.I64, (short)12);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PsAllianceBuildingArmyInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PsAllianceBuildingArmyInfoTupleSchemeFactory();
   ...
   * 个人开始建造时间 *
   */
  public long buildingTime; // optional
  /**
   * 部队详情 *
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 个人开始建造时间 *
     */
    BUILDING_TIME((short)5, "buildingTime"),
    /**
     * 部队详情 *
     */
    DETAIL_INFO((short)6, "detailInfo"),
    /**
     * 行军开始时间 *
     */
     ...
     * 行军总时间 *
     */
    TOTAL_TIME((short)8, "totalTime"),
    /**
     * 是否到达 *
     */
    ARRIVED((short)9, "arrived"),
    /**
     * 行军到达时间 *
     */
    ARRIVE_TIME((short)12, "arriveTime");
  ...
  private static final int __BUILDINGTIME_ISSET_ID = 1;
  private static final int __STARTTIME_ISSET_ID = 2;
  private static final int __TOTALTIME_ISSET_ID = 3;
  private static final int __ARRIVED_ISSET_ID = 4;
  private static final int __ARRIVETIME_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.BUILDING_TIME,_Fields.START_TIME,_Fields.TOTAL_TIME,_Fields.ARRIVED,_Fields.ARRIVE_TIME};
  ...
  static {
    ...
    tmpMap.put(_Fields.BUILDING_TIME, new org.apache.thrift.meta_data.FieldMetaData("buildingTime", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PsAllianceBuildingArmyInfo.class, metaDataMap);
  }

  public PsAllianceBuildingArmyInfo() {
  }
   ...
   */
  public PsAllianceBuildingArmyInfo(PsAllianceBuildingArmyInfo other) {
  ...
  public PsAllianceBuildingArmyInfo deepCopy() {
    return new PsAllianceBuildingArmyInfo(this);
  }
   ...
   * 部队id
   */
  public PsAllianceBuildingArmyInfo setArmyId(long armyId) {
    this.armyId = armyId;
    setArmyIdIsSet(true);
    return this;
  }
   ...
   * 个人开始建造时间 *
   */
  public PsAllianceBuildingArmyInfo setBuildingTime(long buildingTime) {
   ...
   * 部队详情 *
   */
  public PsAllianceBuildingArmyInfo setDetailInfo(@org.apache.thrift.annotation.Nullable PsStationArmyUnit detailInfo) {
    this.detailInfo = detailInfo;
    return this;
  }
   ...
   * 行军开始时间 *
   */
  public PsAllianceBuildingArmyInfo setStartTime(long startTime) {
   ...
   * 行军总时间 *
   */
  public PsAllianceBuildingArmyInfo setTotalTime(long totalTime) {
   ...
   * 是否到达 *
   */
  public PsAllianceBuildingArmyInfo setArrived(boolean arrived) {
   ...
   * 行军到达时间 *
   */
  public PsAllianceBuildingArmyInfo setArriveTime(long arriveTime) {
  ...
  public boolean equals(Object that) {
    if (that instanceof PsAllianceBuildingArmyInfo)
      return this.equals((PsAllianceBuildingArmyInfo)that);
    return false;
  }

  public boolean equals(PsAllianceBuildingArmyInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_buildingTime = true && this.isSetBuildingTime();
    boolean that_present_buildingTime = true && that.isSetBuildingTime();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBuildingTime()) ? 131071 : 524287);
    if (isSetBuildingTime())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(buildingTime);
  ...
  @Override
  public int compareTo(PsAllianceBuildingArmyInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PsAllianceBuildingArmyInfo(");
    boolean first = true;
  ...
  private static class PsAllianceBuildingArmyInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsAllianceBuildingArmyInfoStandardScheme getScheme() {
      return new PsAllianceBuildingArmyInfoStandardScheme();
    }
  }

  private static class PsAllianceBuildingArmyInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<PsAllianceBuildingArmyInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PsAllianceBuildingArmyInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // BUILDING_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.buildingTime = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PsAllianceBuildingArmyInfo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetBuildingTime()) {
        ...
        oprot.writeI64(struct.buildingTime);
        oprot.writeFieldEnd();
      }
  ...
  private static class PsAllianceBuildingArmyInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsAllianceBuildingArmyInfoTupleScheme getScheme() {
      return new PsAllianceBuildingArmyInfoTupleScheme();
    }
  }

  private static class PsAllianceBuildingArmyInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<PsAllianceBuildingArmyInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PsAllianceBuildingArmyInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PsAllianceBuildingArmyInfo struct) throws org.apache.thrift.TException {
