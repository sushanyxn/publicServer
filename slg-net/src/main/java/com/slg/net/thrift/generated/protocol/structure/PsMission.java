...
public class PsMission implements org.apache.thrift.TBase<PsMission, PsMission._Fields>, java.io.Serializable, Cloneable, Comparable<PsMission> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PsMission");
  ...
  private static final org.apache.thrift.protocol.TField UNLOCK_FIELD_DESC = new org.apache.thrift.protocol.TField("unlock", org.apache.thrift.protocol.TType.BOOL, (short)5);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PsMissionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PsMissionTupleSchemeFactory();
  ...
  private static final int __UNLOCK_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.AWARD,_Fields.UNLOCK};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PsMission.class, metaDataMap);
  }
   ...
   */
  public PsMission(PsMission other) {
  ...
  public PsMission deepCopy() {
    return new PsMission(this);
  }
  ...
  public PsMission setMetaId(@org.apache.thrift.annotation.Nullable String metaId) {
    this.metaId = metaId;
    return this;
  }
   ...
   * 任务进度
   */
  public PsMission setProgress(long progress) {
    this.progress = progress;
    setProgressIsSet(true);
    return this;
  }
   ...
   * 任务完成状态
   */
  public PsMission setCompleted(boolean completed) {
    this.completed = completed;
    setCompletedIsSet(true);
    return this;
  }
   ...
   * 领取奖励状态
   */
  public PsMission setAward(boolean award) {
    this.award = award;
    setAwardIsSet(true);
    return this;
  }
   ...
   * 任务解锁状态
   */
  public PsMission setUnlock(boolean unlock) {
    this.unlock = unlock;
    setUnlockIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof PsMission)
      return this.equals((PsMission)that);
    return false;
  }

  public boolean equals(PsMission that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(PsMission other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PsMission(");
    boolean first = true;
  ...
  private static class PsMissionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsMissionStandardScheme getScheme() {
      return new PsMissionStandardScheme();
    }
  }

  private static class PsMissionStandardScheme extends org.apache.thrift.scheme.StandardScheme<PsMission> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PsMission struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PsMission struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PsMissionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PsMissionTupleScheme getScheme() {
      return new PsMissionTupleScheme();
    }
  }

  private static class PsMissionTupleScheme extends org.apache.thrift.scheme.TupleScheme<PsMission> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PsMission struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PsMission struct) throws org.apache.thrift.TException {
