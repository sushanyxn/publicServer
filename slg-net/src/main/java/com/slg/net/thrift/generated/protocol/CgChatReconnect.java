...
public class CgChatReconnect implements org.apache.thrift.TBase<CgChatReconnect, CgChatReconnect._Fields>, java.io.Serializable, Cloneable, Comparable<CgChatReconnect> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CgChatReconnect");
  ...
  private static final org.apache.thrift.protocol.TField LOGIN_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("loginTime", org.apache.thrift.protocol.TType.I64, (short)6);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CgChatReconnectStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CgChatReconnectTupleSchemeFactory();
  ...
  private static final int __LOGINTIME_ISSET_ID = 4;
  private static final int __CSID_ISSET_ID = 5;
  private static final int __OSID_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.LOGIN_TIME,_Fields.CS_ID,_Fields.OS_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CgChatReconnect.class, metaDataMap);
  }

  public CgChatReconnect() {
  }
   ...
   */
  public CgChatReconnect(CgChatReconnect other) {
  ...
  public CgChatReconnect deepCopy() {
    return new CgChatReconnect(this);
  }
   ...
   * 用户id
   */
  public CgChatReconnect setUid(long uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
   ...
   * role id
   */
  public CgChatReconnect setRoleId(long roleId) {
    this.roleId = roleId;
    setRoleIdIsSet(true);
    return this;
  }
  ...
  public CgChatReconnect setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public CgChatReconnect setSign(@org.apache.thrift.annotation.Nullable String sign) {
    this.sign = sign;
    return this;
  }
   ...
   * 客户端最后一次收到的服务端sequence
   */
  public CgChatReconnect setSequence(int sequence) {
    this.sequence = sequence;
    setSequenceIsSet(true);
    return this;
  }
  ...
  public CgChatReconnect setLoginTime(long loginTime) {
  ...
  public CgChatReconnect setCsId(int csId) {
    this.csId = csId;
    setCsIdIsSet(true);
    return this;
  }
  ...
  public CgChatReconnect setOsId(int osId) {
    this.osId = osId;
    setOsIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof CgChatReconnect)
      return this.equals((CgChatReconnect)that);
    return false;
  }

  public boolean equals(CgChatReconnect that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CgChatReconnect other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CgChatReconnect(");
    boolean first = true;
  ...
  private static class CgChatReconnectStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CgChatReconnectStandardScheme getScheme() {
      return new CgChatReconnectStandardScheme();
    }
  }

  private static class CgChatReconnectStandardScheme extends org.apache.thrift.scheme.StandardScheme<CgChatReconnect> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CgChatReconnect struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CgChatReconnect struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CgChatReconnectTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CgChatReconnectTupleScheme getScheme() {
      return new CgChatReconnectTupleScheme();
    }
  }

  private static class CgChatReconnectTupleScheme extends org.apache.thrift.scheme.TupleScheme<CgChatReconnect> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CgChatReconnect struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CgChatReconnect struct) throws org.apache.thrift.TException {
