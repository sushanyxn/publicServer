...
public class PsOfficial implements org.apache.thrift.TBase<PsOfficial, PsOfficial._Fields>, java.io.Serializable, Cloneable, Comparable<PsOfficial> {
   ...
   * 玩家信息 *
   */
  public @org.apache.thrift.annotation.Nullable PsRoleSimpleInfo role; // optional
  ...
  private static final _Fields optionals[] = {_Fields.META_ID,_Fields.ROLE};
   ...
   * 官员metaId *
   */
  public PsOfficial setMetaId(@org.apache.thrift.annotation.Nullable String metaId) {
    this.metaId = metaId;
    return this;
  }
   ...
   * 玩家信息 *
   */
  public PsOfficial setRole(@org.apache.thrift.annotation.Nullable PsRoleSimpleInfo role) {
    this.role = role;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PsOfficial(");
    boolean first = true;
