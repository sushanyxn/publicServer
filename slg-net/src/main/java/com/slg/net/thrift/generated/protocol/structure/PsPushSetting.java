...
public class PsPushSetting implements org.apache.thrift.TBase<PsPushSetting, PsPushSetting._Fields>, java.io.Serializable, Cloneable, Comparable<PsPushSetting> {
   ...
   * 属性
   * 
   * @see com.slg.net.thrift.generated.protocol.constant.PsPushType
   */
  public @org.apache.thrift.annotation.Nullable com.slg.net.thrift.generated.protocol.constant.PsPushType type; // required
  /**
   * 推送开关
   */
  ...
  public PsPushSetting(
    com.slg.net.thrift.generated.protocol.constant.PsPushType type,
    boolean pushSwitch)
  {
    this();
    this.type = type;
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public com.slg.net.thrift.generated.protocol.constant.PsPushType getType() {
    return this.type;
  }
   ...
   * @see com.slg.net.thrift.generated.protocol.constant.PsPushType
   */
  public PsPushSetting setType(@org.apache.thrift.annotation.Nullable com.slg.net.thrift.generated.protocol.constant.PsPushType type) {
    this.type = type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case TYPE:
      if (value == null) {
        ...
        setType((com.slg.net.thrift.generated.protocol.constant.PsPushType)value);
      }
      break;
  ...
  public int compareTo(PsPushSetting other) {
    ...
    lastComparison = Boolean.compare(isSetPushSwitch(), other.isSetPushSwitch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPushSwitch()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PsPushSetting(");
    boolean first = true;
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.slg.net.thrift.generated.protocol.constant.PsPushType.findByValue(iprot.readI32());
