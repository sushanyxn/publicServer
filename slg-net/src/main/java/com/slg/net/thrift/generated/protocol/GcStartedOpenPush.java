...
public class GcStartedOpenPush implements org.apache.thrift.TBase<GcStartedOpenPush, GcStartedOpenPush._Fields>, java.io.Serializable, Cloneable, Comparable<GcStartedOpenPush> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GcStartedOpenPush");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GcStartedOpenPushStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GcStartedOpenPushTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.END_TIME,_Fields.X,_Fields.Y};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GcStartedOpenPush.class, metaDataMap);
  }

  public GcStartedOpenPush() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GcStartedOpenPush(GcStartedOpenPush other) {
  ...
  public GcStartedOpenPush deepCopy() {
    return new GcStartedOpenPush(this);
  }
  ...
  public GcStartedOpenPush setEndTime(long endTime) {
  ...
  public GcStartedOpenPush setX(int x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
  ...
  public GcStartedOpenPush setY(int y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof GcStartedOpenPush)
      return this.equals((GcStartedOpenPush)that);
    return false;
  }

  public boolean equals(GcStartedOpenPush that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GcStartedOpenPush other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GcStartedOpenPush(");
    boolean first = true;
  ...
  private static class GcStartedOpenPushStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GcStartedOpenPushStandardScheme getScheme() {
      return new GcStartedOpenPushStandardScheme();
    }
  }

  private static class GcStartedOpenPushStandardScheme extends org.apache.thrift.scheme.StandardScheme<GcStartedOpenPush> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GcStartedOpenPush struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GcStartedOpenPush struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GcStartedOpenPushTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GcStartedOpenPushTupleScheme getScheme() {
      return new GcStartedOpenPushTupleScheme();
    }
  }

  private static class GcStartedOpenPushTupleScheme extends org.apache.thrift.scheme.TupleScheme<GcStartedOpenPush> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GcStartedOpenPush struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GcStartedOpenPush struct) throws org.apache.thrift.TException {
